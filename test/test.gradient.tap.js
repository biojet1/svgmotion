...
<svg xmlns="http://www.w3.org/2000/svg"
     version="1.1"     width="300"     viewBox="0 0 300 300" >
  ...
  <rect fill="url(#MyGradient)"
	stroke="black" stroke-width="2"	x="25" y="25" width="250" height="150"/>
</svg>`);
  // const d1 = root.dump();
  ...
  root.save_json(`${DIR}/ts-linearGradient.json`)
  root.save_html(`${DIR}/ts-linearGradient.html`);
