...
import { ScalarValue, PointsValue, TextValue, Animatable, VectorValue, UnknownValue } from "../value.js";
...
function update_dom(frame: number, target: Element) {
    ...
    // console.warn("update_dom", target.constructor.name);
    do {
                ...
                if (v instanceof ValueSet || v instanceof Animatable) {
                    ...
                    if (f) {
                        ...
                        if (a) {
                            ...
                            continue;
                        } else if (v instanceof UnknownValue) {
                            elem.setAttribute(n, v.get_repr(frame));
                            continue;
                        }
